...
make_group(gp2,
  ...
  /* 0xf6, 0xf7 */
make_group(gp3,
    IDEX(I_src,test), EMPTY, EX(not), EX(neg),
...
opcode_entry opcode_table [512] = {
  ...
  /* 0xe4 */	IDEXW(in_I2a, pio_read, 1), IDEX(in_I2a, pio_read), IDEXW(out_a2I, pio_write, 1), IDEX(out_a2I, pio_write),
  /* 0xe8 */	IDEX(call_rel,call), IDEX(J_rel,jmp), IDEX(J_ptr,jmp), IDEXW(J_rel,jmp,1),
  /* 0xec */	IDEXW(in_dx2a, pio_read, 1), IDEX(in_dx2a, pio_read), IDEXW(out_a2dx, pio_write, 1), IDEX(out_a2dx, pio_write),
