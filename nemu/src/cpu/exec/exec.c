...
opcode_entry opcode_table [512] = {
  ...
  /* 0x50 */	IDEXW(push_SI,push,1), IDEXW(push_SI,push,1), IDEXW(push_SI,push,1), IDEXW(push_SI,push,1),
  /* 0x54 */	IDEXW(push_SI,push,1), IDEXW(push_SI,push,1), IDEXW(push_SI,push,1), IDEXW(push_SI,push,1),
  ...
  /* 0xe8 */	IDEXW(call_SI,call,1), IDEXW(call_SI,call,1), IDEXW(call_SI,call,1), IDEXW(call_SI,call,1),
