...
opcode_entry opcode_table [512] = {
  ...
  /* 0x28 */	IDEX(sub_r2rm_b,sub), IDEX(sub_r2rm_v,sub), IDEX(sub_rm2r_b,sub), IDEX(sub_rm2r_v,sub),
  /* 0x2c */	IDEX(sub_I2a_b,sub), IDEX(sub_I2a_v,sub), EMPTY, EMPTY,
  ...
  /* 0x50 */	IDEX(push_r32,push), IDEX(push_r32,push), IDEX(push_r32,push), IDEX(push_r32,push),
  /* 0x54 */	IDEX(push_r32,push), IDEX(push_r32,push), IDEX(push_r32,push), IDEX(push_r32,push),
  /* 0x58 */	IDEX(pop_r32,pop), IDEX(pop_r32,pop), IDEX(pop_r32,pop), IDEX(pop_r32,pop),
  /* 0x5c */	IDEX(pop_r32,pop), IDEX(pop_r32,pop), IDEX(pop_r32,pop), IDEX(pop_r32,pop),
  ...
  /* 0x80 */	IDEXW(I2E, gp1, 1), IDEX(I2E, gp1), EMPTY, IDEXW(sub_I2rm_b,sub,1)/*IDEX(SI2E, gp1)*/,
  ...
  /* 0xe8 */	IDEX(call_SI,call), IDEX(J,jmp), IDEX(J,jmp), IDEX(J,jmp),
