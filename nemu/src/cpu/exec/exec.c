...
opcode_entry opcode_table [512] = {
  ...
  /* 0x60 */	IDEX(none,pusha), IDEX(none,popa), EMPTY, EMPTY,
  /* 0x64 */	EMPTY, EMPTY, EX(operand_size), EMPTY,
  /* 0x68 */	IDEX(push_SI,push), IDEX(I_E2G,imul3), IDEXW(push_SI,push,1), IDEXW(I_E2G,imul3,1),  /*mul3的情况还未完善*/
  /* 0x6c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x70 */	IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1),
  /* 0x74 */	IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1),
  /* 0x78 */	IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1),
  /* 0x7c */	IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1), IDEXW(J_rel,jcc,1),
  ...
  /* 0x90 */	IDEX(none, nop), EMPTY, EMPTY, EMPTY,
  /* 0x94 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x98 */	EMPTY, IDEX(none,cltd), IDEX(call_ptr,call), EMPTY,
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), IDEX(gp2_Ib2E, gp2), IDEX(SI,ret_I), IDEX(none, ret),
  ...
  /* 0xe8 */	IDEX(call_rel,call), IDEX(J_rel,jmp), IDEX(J_ptr,jmp), IDEXW(J_rel,jmp,1),
  ...
  /* 0x80 */	IDEX(J_rel,jcc), IDEX(J_rel,jcc), IDEX(J_rel,jcc), IDEX(J_rel,jcc),
  /* 0x84 */	IDEX(J_rel,jcc), IDEX(J_rel,jcc), IDEX(J_rel,jcc), IDEX(J_rel,jcc),
  /* 0x88 */	IDEX(J_rel,jcc), IDEX(J_rel,jcc), IDEX(J_rel,jcc), IDEX(J_rel,jcc),
  /* 0x8c */	IDEX(J_rel,jcc), IDEX(J_rel,jcc), IDEX(J_rel,jcc), IDEX(J_rel,jcc),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(mov_Eb2G,movzx), IDEX(mov_E2G,movzx),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEX(mov_Eb2G,movsx), IDEX(mov_E2G,movsx),
